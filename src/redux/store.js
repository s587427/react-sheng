...
export default configureStore({
  ...
  middleware: (getDefaultMiddleware) => getDefaultMiddleware().concat(logger).concat(sagaMiddleware), // getDefaultMiddleware這個方法使可以用默認添加的middleware,concat則是添加客製化middleware使可以用默認添加的middleware組合客製化     
